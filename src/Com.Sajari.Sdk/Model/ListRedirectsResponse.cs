...
namespace Com.Sajari.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListRedirectsResponse")]
    public partial class ListRedirectsResponse : IEquatable<ListRedirectsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRedirectsResponse" /> class.
        /// </summary>
        ...
        public ListRedirectsResponse(string nextPageToken = default(string), List<Redirect> redirects = default(List<Redirect>))
        {
        ...
        {
            return this.Equals(input as ListRedirectsResponse);
        }

        /// <summary>
        /// Returns true if ListRedirectsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListRedirectsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListRedirectsResponse input)
        {
            if (input == null)
            {
                return false;
